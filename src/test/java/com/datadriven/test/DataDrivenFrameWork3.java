...
public class DataDrivenFrameWork3 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		FileInputStream fis=new FileInputStream("D:\\batch229\\workspace\\datadrivenapachepoi\\src\\main\\java\\com\\testdata\\MercuryToursTestDataPractice3.xlsx");
		...
		short firstCol=sheet.getRow(0).getFirstCellNum();
		...
		for(int i=1; i<=lastRowNum; i++)
		{
			...
			fos=new FileOutputStream("D:\\batch229\\workspace\\datadrivenapachepoi\\src\\main\\java\\com\\testdata\\MercuryToursTestDataPractice3.xlsx");
			
			//Message to be written in the excel sheet
			String message="Pass";
			
			//Create cell where data needs to be written
			sheet.getRow(i).createCell(k+10).setCellValue(message);
		}
